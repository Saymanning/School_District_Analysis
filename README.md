...
## Summary
The affect of replacing the ninth grade math and reading scores at Thomas High School with NaN(Null) was very minimal on the dataset as a whole. The minor changes were as follows: The average math score wetn from 83.418 to 83.351. Average reading score went from 83.849 to 83.896. The percent passing math went from 93.272 to 93.186. The passing reading percent from 97.309 to 97.019 and overall percent passing from 90.948 to 90.630.
